...
def max_product_in(grid, options = {})
  max_product = 0
  for i in 0...grid.size
    for j in 3...grid.size
...
max_landscape = max_product_in(grid, direction: :landscape)
max_vertical = max_product_in(grid, direction: :vertical)

max_product = [max_landscape, max_vertical].max

for row in 0...(grid.size - 3)
  for column in 3...grid.size
